...
public class OurCreature extends Creature
{
  ...
  private void makeNotFlappy()
  {
    ...
    Vector3f torsoSize = new Vector3f( 1.0f, 1.0f, 1.0f);
    Vector3f leg1Size  = new Vector3f( 3.0f, 0.5f, 0.5f);
    Vector3f leg2Size  = new Vector3f( 3.0f, 0.5f, 0.5f);
    Vector3f leg3Size = new Vector3f(0.5f, 0.5f, 3.0f);
    Vector3f pivot3A = new Vector3f(0.0f, -1.0f, 1.0f);
    Vector3f pivot3B = new Vector3f(0.0f, 0.5f, -3.0f);
    Vector3f pivot4A = new Vector3f(0.0f, -1.0f, -1.0f);
    ...
    Vector3f pivotA = new Vector3f( 1.0f, -1.0f,  0.0f); //Center of hinge in the block's coordinates
    Vector3f pivotB = new Vector3f(-3.0f,  0.5f,  0.0f); //Center of hinge in the block's coordinates
    ...
    Vector3f pivotC = new Vector3f(-1.0f, -1.0f,  0.0f); //Center of hinge in the block's coordinates
    Vector3f pivotD = new Vector3f( 3.0f,  0.5f,  0.0f); //Center of hinge in the block's coordinates
